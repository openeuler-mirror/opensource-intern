            ...
            if (200 === dataMap.code) {
                ...
                if (dataMap.mxGraphComponentList) {
                    ...
                    for (var index = 0; index < mxGraphComponentList.length; index++) {
                        ...
                        if (component_prefix.indexOf("/openEuler-web/") > -1) {
                            component_prefix = component_prefix.replace('/openEuler-web', web_header_prefix)
                        }
    ...
    ajaxRequest({
        ...
        success: function (data) {//After the request is successful
            ...
            nodeImageList.forEach(item => {
                ...
                console.log("-------------------------------");
                image.src = web_header_prefix + (item.imageUrl.replace("/openEuler-web", ""));
...
function updateMxGraphCellImage(cellEditor, selState, newValue, fn) {
    ...
    layui.use('upload', function () {
        ...
        var uploadInst = upload.render({
            ...
            , url: '/openEuler-web/mxGraph/uploadNodeImage' //上传接口
            , headers: {
